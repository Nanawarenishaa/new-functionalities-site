...
const TopSelling = () => {
  ...
  return (
    <div className="container w-full h-screen flex flex-col gap-12 place-content-center mx-auto px-4 py-24">
          ...
          <div key={product.id} className="px-2 py-8">  
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="mt-2 text-yellow-400">{'★'.repeat(product.rating)}</span>
                <motion.button 
